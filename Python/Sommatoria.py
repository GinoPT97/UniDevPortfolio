...
def calcola_stagione_2025_26():
    ...
    :return: tuple (rimborsi_totali, pagato_totale, da_ricevere)
    """
    Rimborso = [63, 79, 70, 61, 63, 63, 63, 70, 70, 61, 70, 79, 63, 70, 63, 63, 70, 61, 61, 70, 63, 63, 70, 61, 70, 70, 63, 61, 70, 54, 37, 63, 70, 63, 79, 63, 63, 61, 61, 37, 63, 63, 63]
    
    Pagato = [63, 140, 259, 350, 133, 131, 257, 133, 107, 196, 142, 61]
