...
Benvenuto nel mio **UniDevPortfolio**, una raccolta di progetti e script sviluppati durante il mio percorso di studi alla **Federico II**. Questo repository raccoglie il codice scritto per esami e progetti nei seguenti corsi universitari: **Laboratorio di Programmazione**, **Laboratorio di Algoritmi e Strutture Dati**, **Basi di Dati**, **Programmazione Orientata agli Oggetti**, **Tech-Web**, **Sistemi Operativi**, **Architettura degli Elaboratori**, e **Sviluppo Android**. Ogni progetto rappresenta una sfida risolta utilizzando diverse tecniche di programmazione e tecnologie.

In questo repository, troverai una varietà di progetti sviluppati in linguaggi come **C**, **C++**, **Java**, **JavaScript**, **SQL**, **Prolog**, **Standard ML**, **Bash**, **Assembly** e **Android Studio**.
...
Questo portfolio copre una vasta gamma di linguaggi di programmazione e tecnologie, dimostrando la mia capacità di affrontare diversi paradigmi di sviluppo e tecniche di programmazione. Le principali tecnologie utilizzate includono:

- **C**: Per esercizi di laboratorio di programmazione, sistemi operativi, e creazione di server.
- **C++**: Per studi ed esercitazioni personali su tecniche di programmazione avanzate.
- **Java**: Per applicare i principi della programmazione orientata agli oggetti e lo sviluppo di applicazioni.
- **JavaScript, HTML, CSS**: Per lo sviluppo di applicazioni web e tecnologie front-end e back-end.
- **SQL**: Per la progettazione di basi di dati, query avanzate e gestione dei dati.
- **Prolog**: Per esplorare la logica della programmazione e la risoluzione di problemi attraverso la programmazione dichiarativa.
- **Standard ML**: Per applicazioni di programmazione funzionale e concetti avanzati di linguaggi funzionali.
- **Bash**: Per automazione e scripting in ambiente Unix/Linux, inclusi esercizi di laboratorio di sistemi operativi.
- **Assembly**: Per comprendere l'architettura degli elaboratori e la programmazione a basso livello.
...
- **Crescita professionale**: I progetti riflettono il mio impegno nell'approfondire continuamente nuove tecnologie e paradigmi di programmazione. Ogni progetto è una testimonianza del mio percorso di apprendimento.
- **Ottimizzazione e best practices**: In tutti i progetti è stata applicata una particolare attenzione alla scrittura di codice efficiente e ben strutturato, rispettando le best practices di sviluppo software.
