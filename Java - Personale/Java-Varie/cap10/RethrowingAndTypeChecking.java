...
public class RethrowingAndTypeChecking
{
    public static void runException(String what) throws ExceptionA, ExceptionB
    {
        ...
        {
            // rilancia e che può essere di tipo ExceptionA o di tipo ExceptionB così come indicato
    ...
    public static void main(String args[])
    {
        ...
        catch (ExceptionA | ExceptionB e) { System.out.println(e.getClass().toString()); }
    }
}
