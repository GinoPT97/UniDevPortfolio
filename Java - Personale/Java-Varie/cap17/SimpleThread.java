...
class DoJobRun implements Runnable // run tramite una classe che implementa l'interfaccia Runnable
{
...
class DoJobTh extends Thread // run tramite una classe che eredita dalla classe Thread
{
    private String msg = " sarà occupato per i prossimi ";
