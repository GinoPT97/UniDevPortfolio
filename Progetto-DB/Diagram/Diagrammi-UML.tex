...
\draw[relation] (cliente) -- node[midway, right] {effettua} node[near start, below] {1} node[near end, below] {*} (ordine);

% Relazioni Dipendente
\draw[relation] (dipendente) -- node[midway, left] {gestisce} node[near start, below] {1} node[near end, below] {*} (ordine);
...
\draw[relation] (articoli) -- node[midway, left] {riferisce} node[near start, below] {*} node[near end, below] {1} (prodotto);
...
\draw[relation] (cliente2) -- node[pos=0.6, left] {possiede} node[near start, below] {1} node[near end, below] {1} (tessera2);
\draw[relation] (cliente2) -- node[pos=0.5, right] {effettua} node[near start, below] {1} node[near end, below] {*} (ordine2);
\draw[relation] (dipendente2) -- node[pos=0.5, left] {gestisce} node[near start, below] {1} node[near end, below] {*} (ordine2);
