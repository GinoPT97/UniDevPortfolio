...
\renewcommand{\arraystretch}{1.35}
\arrayrulecolor{myblue}
{\scriptsize % Ridotto da \footnotesize a \scriptsize
...
AFTER INSERT ON \newline\texttt{articoli\-ordine} &
\texttt{Aggiorna\-Scorta\-EPunti()} &
Decrementa la scorta del prodotto e incrementa i punti fedeltà del cliente (10\% del valore speso). \\
\hline
\texttt{TrgAggiorna\-Prezzo\-Ordine} &
AFTER INSERT ON \newline\texttt{articoli\-ordine} &
\texttt{Aggiorna\-Prezzo\-Ordine()} &
Ricalcola il prezzo totale dell'ordine sommando il costo dei nuovi articoli. \\
\hline
\rowcolor{mygray}
...
Di seguito vengono descritte le logiche implementate in ciascuna funzione:
