...
\draw[thick] (spec_prod) -- node[midway, above] {$\cup$} (frutta); 
\draw[thick] (spec_prod) -- node[midway, above] {$\cup$} (verdura); 
\draw[thick] (spec_prod) -- node[midway, above] {$\cup$} (confezionati); 
\draw[thick] (spec_prod) -- node[midway, above] {$\cup$} (farinacei); 
\draw[thick] (spec_prod) -- node[midway, above] {$\cup$} (uova); 
\draw[thick] (spec_prod) -- node[midway, above] {$\cup$} (latticini);
