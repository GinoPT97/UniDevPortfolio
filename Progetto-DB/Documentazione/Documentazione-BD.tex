...
\begin{center}
    \includegraphics[width=0.95\textwidth]{../Immagini/Diagram-ER.png}
\end{center}

\subsection{Diagramma concettuale}
% Inserimento immagine diagramma concettuale
\begin{center}
    \includegraphics[width=0.95\textwidth]{../Immagini/DiagramNonRistrutturato.png}
\end{center}

\subsection{Diagramma concettuale ristrutturato}
% Inserimento immagine diagramma concettuale ristrutturato
\begin{center}
    \includegraphics[width=0.95\textwidth]{../Immagini/DiagrammaRistrutturato.png}
\end{center}
