...
\noindent
Il dizionario delle entità descrive le principali tabelle del database, specificando il ruolo di ciascuna nel sistema informativo.
...
\vspace{1.5em}
\subsection{Trigger e procedure}
\noindent
I trigger e le procedure automatizzano la gestione e il controllo dei dati, migliorando la robustezza del sistema.
