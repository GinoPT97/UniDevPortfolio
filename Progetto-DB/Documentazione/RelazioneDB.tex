...
Di seguito è riportato per intero il contenuto del file \texttt{Tabelle.sql}, che definisce la struttura delle tabelle e i vincoli principali del database:

\begin{lstlisting}[style=sqlstyle,caption={Contenuto completo di Tabelle.sql}]
