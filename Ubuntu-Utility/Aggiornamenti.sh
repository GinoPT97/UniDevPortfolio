...
# Pulizia dei container inattivi da oltre 12 ore
log "INFO" "Pulizia dei container inutilizzati da oltre 12h..."
docker container prune --filter "until=12h" -f

# Pulizia delle immagini inutilizzate da oltre 12 ore
log "INFO" "Pulizia delle immagini inutilizzate da oltre 12h..."
docker image prune -a --filter "until=12h" -f

# Pulizia dei network inutilizzati da oltre 12 ore (se il filtro è supportato)
log "INFO" "Pulizia dei network inutilizzati da oltre 12h..."
docker network prune --filter "until=12h" -f
