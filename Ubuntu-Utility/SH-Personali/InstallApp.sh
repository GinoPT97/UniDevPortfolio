...
sudo apt install wget curl deborphan zram-config preload flatpak git gparted gpart openjdk-11-jdk openjdk-11-jre clamav clamtk postgresql-15 postgresql-client-15 postgresql-client-common postgresql-common codeblocks gnome-boxes arduino telegram-desktop vlc cmake deja-dup discord docker eclipse pycharm-community skype swi-prolog teams-for-linux vlc whatsie zoom-client libnvidia-gl-535:i386 tor -y
