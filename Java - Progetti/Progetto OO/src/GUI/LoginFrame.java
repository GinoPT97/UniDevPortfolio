...
public class LoginFrame extends JFrame {
	...
	public void elementi() {
	    ...
	    logbutt.setBackground(new Color(0, 255, 0));
	...
	private void azioni(Controller c) {
	    // ActionListener per il pulsante Login
	    ...
	    // ActionListener per il pulsante Clear
	    clearbutt.addActionListener(e -> idtf.setText(""));

	    // Gestione dell'evento tasto Invio
	    idtf.addActionListener(e -> logbutt.doClick()); // Simula il click sul pulsante Login quando si preme Invio
	}
