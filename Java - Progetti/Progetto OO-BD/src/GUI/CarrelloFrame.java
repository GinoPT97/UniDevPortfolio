	...
	public void azioni(Controller c) throws SQLException {
		selectbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				prodmodel.setRowCount(0);
				try {
					if(categoriacb.getSelectedItem().equals("Ortofrutticoli")) c.categoriaprodotti("Ortofrutticoli", prodmodel);
					else if (categoriacb.getSelectedItem().equals("Inscatolati")) c.categoriaprodotti("Inscatolati", prodmodel); 
					else if (categoriacb.getSelectedItem().equals("Farinacei")) c.categoriaprodotti("Farinacei", prodmodel);
					else if (categoriacb.getSelectedItem().equals("Latticini")) c.categoriaprodotti("Latticini", prodmodel);
		...
		insertbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(i==-1 && quantitatf.getText().equals("")) JOptionPane.showMessageDialog(null, "Seleziona un prodotto e la quantita'!");
				else if(i==-1) JOptionPane.showMessageDialog(null, "Seleziona un prodotto!");
				else if(quantitatf.getText().equals("")) JOptionPane.showMessageDialog(null, "Seleziona la quantita'!");
				else if(Integer.parseInt(prodmodel.getValueAt(i, 4).toString())<Integer.parseInt(quantitatf.getText())) JOptionPane.showMessageDialog(null, "Scorte insufficenti!");
				else {
