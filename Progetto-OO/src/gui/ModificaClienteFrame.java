...
public class ModificaClienteFrame extends JFrame {
	...
	public void viewct(String codCl, String nome, String cognome, String codFis, String indirizzo, String email,
			String telefono) {
		cod = codCl;
	...
	private void azioni(Controller c) {
		...
		addbutton.addActionListener(e -> {
			...
			try {
				c.upcliente(cod, fields[0].getText(), fields[1].getText(), fields[2].getText(), fields[3].getText(),
