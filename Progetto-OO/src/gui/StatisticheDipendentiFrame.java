...
public class StatisticheDipendentiFrame extends JFrame {
	...
	private JLabel periodoLab, cognomeVenditeLab, titleLabel, startLab, finalLab, nomeLab, cognomeLab, introitiValLab,
			nomeVenditeLab, venditeValLab;
	...
	private void elementi() {
		...
		searchLayout.setHorizontalGroup(searchLayout.createSequentialGroup()
				.addGroup(searchLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(periodoLab)
						.addComponent(startLab).addComponent(finalLab).addComponent(periodoCB))
				.addGroup(searchLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(startTF)
						.addComponent(finalTF).addComponent(selectButton)));

		searchLayout.setVerticalGroup(searchLayout.createSequentialGroup().addComponent(periodoLab)
				.addGroup(searchLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(startLab)
						.addComponent(startTF))
				.addGroup(searchLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(finalLab)
						.addComponent(finalTF))
				.addGroup(searchLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(periodoCB)
		...
		introitiLayout.setHorizontalGroup(introitiLayout.createSequentialGroup()
				.addGroup(introitiLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(nomeLab)
						.addComponent(cognomeLab).addComponent(introitiValLab))
				.addGroup(introitiLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(introitiFields[0]).addComponent(introitiFields[1])
						.addComponent(introitiFields[2])));

		introitiLayout.setVerticalGroup(introitiLayout.createSequentialGroup()
				.addGroup(introitiLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(nomeLab)
						.addComponent(introitiFields[0]))
				.addGroup(introitiLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(cognomeLab)
						.addComponent(introitiFields[1]))
				.addGroup(introitiLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
						.addComponent(introitiValLab).addComponent(introitiFields[2])));
		...
		venditeLayout.setHorizontalGroup(venditeLayout.createSequentialGroup()
				.addGroup(venditeLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(nomeVenditeLab)
						.addComponent(cognomeVenditeLab).addComponent(venditeValLab))
				.addGroup(venditeLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(venditeFields[0]).addComponent(venditeFields[1]).addComponent(venditeFields[2])));

		venditeLayout.setVerticalGroup(venditeLayout.createSequentialGroup()
				.addGroup(venditeLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(nomeVenditeLab)
						.addComponent(venditeFields[0]))
				.addGroup(venditeLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
						.addComponent(cognomeVenditeLab).addComponent(venditeFields[1]))
				.addGroup(venditeLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(venditeValLab)
		...
		searchButton.addActionListener(e -> {
			...
			try {
				...
				if (ordInt.isEmpty() || ordVen.isEmpty()) {
					...
					for (int i = 0; i < 3; i++)
						introitiFields[i].setText(ordInt.get(i));
					for (int i = 0; i < 3; i++)
						venditeFields[i].setText(ordVen.get(i));
				}
	...
	private void clean() {
		startTF.setText("");
		finalTF.setText("");
		for (JTextField f : introitiFields)
			f.setText("");
		for (JTextField f : venditeFields)
			f.setText("");
	}
}
