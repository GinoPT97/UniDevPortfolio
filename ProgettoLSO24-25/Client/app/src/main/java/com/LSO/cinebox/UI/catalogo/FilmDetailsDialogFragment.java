...
public class FilmDetailsDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        Film film = (Film) getArguments().getSerializable(ARG_FILM);
        ...
        votoMedio.setTextColor(getResources().getColor(android.R.color.white));
        votoMedio.setBackgroundResource(R.drawable.badge_bg);
        votoMedio.setBackgroundTintList(getResources().getColorStateList(R.color.orange));
